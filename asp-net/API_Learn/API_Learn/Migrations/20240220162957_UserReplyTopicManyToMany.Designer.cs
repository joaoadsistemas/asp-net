...
namespace DSLearn.Migrations
{
    ...
    [Migration("20240220162957_UserReplyTopicManyToMany")]
    partial class UserReplyTopicManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DSLearn.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f640c0b5-f8d3-4e0a-8643-f5df72ab485e",
                            ...
                            SecurityStamp = "2cb5ded1-c58d-4f7f-9546-c30eba5a1c26",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "896f8668-3189-4bfb-818d-d027704aa926",
                            Email = "bob@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PasswordHash = "$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG",
                            PhoneNumberConfirmed = false,
                            RefreshTokenExpiryTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SecurityStamp = "0ee24c61-21af-4563-98f2-b674927ece7e",
                            TwoFactorEnabled = false,
                            UserName = "Bob Brown"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "dfad1ca1-e144-49c0-a5ad-82e2204422c4",
                            ...
                            PhoneNumberConfirmed = false,
                            RefreshTokenExpiryTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SecurityStamp = "bd60dff2-ff9b-4b40-94a1-7df23484c0fd",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("ReplyUser", b =>
                {
                    ...
                    b.HasKey("LikesId", "ReplyLikesId");

                    b.HasIndex("ReplyLikesId");
            ...
            modelBuilder.Entity("TopicUser", b =>
                {
                    ...
                    b.Property<int>("TopicLikesId")
                        .HasColumnType("int");

                    b.HasKey("LikesId", "TopicLikesId");

                    b.HasIndex("TopicLikesId");
            ...
            modelBuilder.Entity("DSLearn.Entities.Topic", b =>
                {
                    b.HasOne("DSLearn.Entities.Reply", "Answer")
                        .WithMany()
